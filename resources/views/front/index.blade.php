...
<body class="text-black font-poppins pt-10 pb-[50px]">
    <div id="hero-section" class="max-w-[1200px] mx-auto w-full flex flex-col gap-10 pb-[50px] bg-[url('assets/background/Hero-Banner.png')] bg-center bg-no-repeat bg-cover rounded-[32px] overflow-hidden">
        <nav class="flex justify-between items-center pt-6 px-[50px] relative">
            <a href="{{ route('front.index') }}">
                <img src="assets/logo/logo.svg" alt="logo">
            </a>
            <ul class="flex items-center gap-[30px] text-white absolute left-1/2 transform -translate-x-1/2">
                <li>
        ...
        <div class="flex flex-col items-center gap-[30px]">
            ...
            <div class="flex flex-col gap-[10px]">
                ...
                <p class="text-center text-xl leading-[36px] text-[#F5F8FA]">Cognitio provides high quality online courses for you to grow <br>
    ...
    <section id="Top-Categories" class="max-w-[1200px] mx-auto flex flex-col p-[70px_50px] gap-[30px]">
        ...
        <div class="grid grid-cols-4 gap-[30px]">
            ...
            <a href="{{ route('front.category', 'business-inteligence') }}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
        ...
        <div class="grid grid-cols-3 gap-[30px]">
            <a href="{{ route('front.category', 'product-customer-data-analytic') }}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-1.svg" class="object-contain" alt="icon">
                </div>
